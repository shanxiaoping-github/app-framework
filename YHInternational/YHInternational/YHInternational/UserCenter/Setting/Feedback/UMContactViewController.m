...
- (void)viewDidLoad {
    ...
    self.navigationItem.title = @"填写联系信息";//NSLocalizedString(@"Fill in the Contact1", @"填写联系信息");
    self.view.backgroundColor = [UIColor colorWithRed:238.0 / 255 green:238.0 / 255 blue:238.0 / 255 alpha:1.0];

    [self setupCancelBtn];
    [self setupSaveBtn];

    self.textView.text = @"请留下您的QQ，邮箱，电话等联系方式";//NSLocalizedString(@"Fill in the Contact2", @"请留下您的QQ，邮箱，电话等联系方式");
