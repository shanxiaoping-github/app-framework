...
- (void)shareClick {
    ...
    [self removeFromSuperview];
    [self shareToSNSWithImage:[UIImage imageNamed:@"RedPaper"]] ;
}
...
- (void)shareToSNSWithImage:(UIImage *)shareImage{
    ...
    [[BBGShareManager sharedInstance] shareToSnsSheetView:[UIApplication sharedApplication].keyWindow.rootViewController shareText:shareText shareImage:shareImage shareToSnsNames:nil shareUrl:shareUrl clickPlatformCallBack:^(NSString *snsName) {
