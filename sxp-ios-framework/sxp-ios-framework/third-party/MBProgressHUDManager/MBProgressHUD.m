...
- (void)showWhileExecuting:(SEL)method onTarget:(id)target withObject:(id)object animated:(BOOL)animated isAutoHide:(BOOL)autoHide{
...
- (void)showWhileExecuting:(SEL)method onTarget:(id)target withObject:(id)object animated:(BOOL)animated{
  [self showWhileExecuting:method onTarget:target withObject:object animated:animated isAutoHide:YES];
}
